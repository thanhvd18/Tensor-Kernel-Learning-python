...
from utils import *
# load data
args_dataPathList = fr'D:\DeepKernelLearning/data/AD_CN/GM.csv,D:\DeepKernelLearning/data/AD_CN/PET.csv,D:\DeepKernelLearning/data/AD_CN/CSF.csv,D:\DeepKernelLearning/data/AD_CN/SNP.csv'
...
df_y = pd.read_csv(fr'D:\DeepKernelLearning/data/AD_CN/AD_CN_label.csv')    
y = df_y['encoded']
le = LabelEncoder()
